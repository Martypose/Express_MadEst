...
socket.on('medidas', async (dataArray) => {
  try {
    ...
    // ---- estadísticas de la Pi (ahora con hostname/cámara) ----
...
module.exports = (server) => {
  const io = new Server(server, {
    ...
    pingTimeout: 60000,      // + tolerante a CPU spikes
    connectTimeout: 45000,   // conecta incluso con latencia ocasional
    allowEIO3: true,         // por si alguna Pi lleva lib antigua
    cors: {
